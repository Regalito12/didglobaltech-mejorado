...
const slides = [
  ...
  { image: 'assets/visual-security-v2.webp', eyebrow: 'CIBERSEGURIDAD POR CAPAS', title: 'Protección que<br /><em>se anticipa.</em>', copy: 'Integramos controles, segmentación, respaldo y monitoreo para reducir riesgos y mantener tu operación disponible.' },
  { image: 'assets/visual-operations-v2.webp', eyebrow: 'COMUNICACIONES QUE FLUYEN', title: 'Cada llamada<br /><em>en su lugar.</em>', copy: 'Conectamos centrales IP, IVR y automatizaciones para que la atención sea más ordenada y medible.' },
  { image: 'assets/visual-datacenter-v2.webp', eyebrow: 'GESTIÓN QUE ACLARA', title: 'Datos listos para<br /><em>decidir.</em>', copy: 'Ordenamos la información de tu operación con sistemas de gestión que conectan equipos, procesos y resultados.' },
];
let currentSlide = 0;
...
const enhanceProjects = () => {
  ...
  cases.innerHTML = `<div class="case-heading"><span class="section-index">CASOS DE IMPLEMENTACIÓN</span><h2 id="cases-title">Problemas reales.<br /><em>Arquitecturas que responden.</em></h2><p>Estos escenarios muestran cómo se conectan nuestras capacidades. El alcance final se define después del diagnóstico de cada organización.</p></div><div class="case-grid"><article class="case-study-card"><img src="assets/visual-network-v2.webp" alt="Red corporativa conectada con nodos de infraestructura" loading="lazy" /><div><span>CASO TIPO / CONECTIVIDAD</span><h3>Una operación que necesita crecer sin perder control.</h3><p>Diseño de red, segmentación, Wi-Fi empresarial, enlaces redundantes y documentación para conectar sedes y equipos.</p><a class="text-link" href="contacto.html">Evaluar un escenario similar <span>↗</span></a></div></article><article class="case-study-card"><img src="assets/visual-security-v2.webp" alt="Arquitectura de seguridad protegiendo sistemas y datos" loading="lazy" /><div><span>CASO TIPO / CONTINUIDAD</span><h3>Más visibilidad para proteger la operación.</h3><p>Capas de seguridad, respaldo, controles de acceso y monitoreo coordinados para reducir exposición y responder mejor.</p><a class="text-link" href="contacto.html">Hablar con un especialista <span>↗</span></a></div></article><article class="case-study-card"><img src="assets/visual-datacenter-v2.webp" alt="Sala técnica de centro de datos preparada para continuidad" loading="lazy" /><div><span>CASO TIPO / SALA TÉCNICA</span><h3>Una base crítica preparada para el siguiente nivel.</h3><p>Racks, energía, servidores, almacenamiento y seguridad física y lógica organizados alrededor de la continuidad.</p><a class="text-link" href="contacto.html">Diseñar la siguiente etapa <span>↗</span></a></div></article></div>`;
