...
const slides = [
  ...
  { image: 'assets/visual-communications-v2.webp', eyebrow: 'COMUNICACIONES QUE FLUYEN', title: 'Cada llamada<br /><em>en su lugar.</em>', copy: 'Conectamos centrales IP, IVR y automatizaciones para que la atención sea más ordenada y medible.' },
  { image: 'assets/visual-operations-v2.webp', eyebrow: 'GESTIÓN QUE ACLARA', title: 'Datos listos para<br /><em>decidir.</em>', copy: 'Ordenamos la información de tu operación con sistemas de gestión que conectan equipos, procesos y resultados.' },
];
let currentSlide = 0;
